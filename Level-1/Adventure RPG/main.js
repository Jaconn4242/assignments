...
function Intro(){
    ...
    let keepGoing = true
    while(keepGoing){
        let command = readline.keyIn(["Press W to walk ", "Press P to check backpack items ", "Press E to exit the game"])
        if(command === "w"){
            attackChance()
        } else if(command === "p"){
            console.log("Player: " + userName + ", hp: "+ user.hp +", Inventory: " + inventory)
        } else if(command === "e"){
            exitGame()
        } else {
